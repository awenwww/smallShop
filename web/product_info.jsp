		...
		<div class="row">
			...
			<div style="margin: 0 auto; width: 950px;">
				...
				<div class="col-md-6">
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">${productInfo.shop_price}</strong> 参 考 价：
					...
					<div
						...
						<div><a href="${pageContext.request.contextPath}/ProductServlet?method=prByCategory&cid=${cid}&currentPage=${currentPage}">返回上一页</a></div>
					</div>
				</div>
			</div>
			...
			<div style="width: 950px; margin: 0 auto;">
				<div
					...
					<strong>商品介绍:</strong>
					<p>${productInfo.pdesc}</p>
				</div>

				<div>
					<!-- <imgsrc="image/r___________renleipic_01/bigPic139f030b-d68b-41dd-be6d-b94cc568d3c5.jpg"> -->
				</div>
